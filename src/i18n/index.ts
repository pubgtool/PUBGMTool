...
const BASE_DICTIONARIES: Record<Lang, Dict> = {
  ru: {
    ...
    'nav.maps': 'Drop Spots',
    'nav.tips': 'Tips & Coach',
    'nav.short.sensitivity': 'Сенс',
    'nav.short.controls': 'Кнопки',
    'nav.short.pro': 'Про',
    'nav.short.tips': 'Гайды',
    'nav.short.device': 'Девайс',
    'lang.ru': 'RU',
    'lang.en': 'EN',
    'app.hero.eyebrow': 'PUBG MOBILE',
    'module.sensitivity.tagline': 'Подбери чувствительность под устройство и стиль игры',
    'module.controls.tagline': 'Важные настройки контролов в одном месте',
    'module.pro.tagline': '23+ pro-настройки для видимости и скорости',
    'module.hud.tagline': 'Сгенерируй удобную раскладку HUD',
    'module.gyro.tagline': '3-минутный гайд калибровки гироскопа',
    'module.recoil.tagline': 'Карты отдачи топ-оружия с pull-vector',
    'module.drill.tagline': 'Тренажёр хедшотов: точность и среднее время',
    'module.ttk.tagline': 'Сравни TTK любых пушек против любого шлема',
    'module.reaction.tagline': 'Замерь свою реакцию (5-фазовый тест)',
    'module.falloff.tagline': 'Урон по дистанции и зонам попадания',
    'module.loadout.tagline': 'Собери идеальный лут под локацию и стиль',
    'module.crosshair.tagline': 'Тренажёр Flick / Track / Target switching',
    'module.device.tagline': 'Профиль устройства и оптимальные пресеты',
    'module.maps.tagline': 'Тир-лист точек высадки на каждой карте',
    'module.tips.tagline': 'Стратегии и советы от Newbie до Pro',
  ...
  en: {
    ...
    'lang.en': 'EN',
    'app.hero.eyebrow': 'PUBG MOBILE',
    'module.sensitivity.tagline': 'Tune sensitivity for your device and play style',
    'module.controls.tagline': 'All the important PUBGM control settings in one place',
    'module.pro.tagline': '23+ pro-tier tweaks for visibility and speed',
    'module.hud.tagline': 'Generate a comfortable HUD layout',
    'module.gyro.tagline': '3-minute gyroscope calibration walkthrough',
    'module.recoil.tagline': 'Recoil maps for top weapons with pull-vectors',
    'module.drill.tagline': 'Headshot drill: accuracy and avg reaction',
    'module.ttk.tagline': 'Compare TTK across guns vs any helmet',
    'module.reaction.tagline': 'Measure your reaction time (5-phase test)',
    'module.falloff.tagline': 'Damage by distance and hitbox zone',
    'module.loadout.tagline': 'Build the perfect loadout for any spot and style',
    'module.crosshair.tagline': 'Flick / Track / Target-switching trainer',
    'module.device.tagline': 'Your device profile and the best presets for it',
    'module.maps.tagline': 'Tier list of drop spots for every map',
    'module.tips.tagline': 'Strategy and tips from Newbie to Pro',
